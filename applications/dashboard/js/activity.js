...
/* Comments */
   ...
   $('ul.ActivityComments form input.Button').live('click', function() {
	  ...
	  if( $.sceditor || $(textbox).data('sceditor') ) {
		$(textbox).data('sceditor').updateTextareaValue();
	  }
      ...
      $.ajax({
         ...
         success: function(json) {
            ...
            if (json.FormSaved == false) {
               ...
               textbox.val('').blur();
			    if( $.sceditor || textbox.data('sceditor') ) {
					textbox.data('sceditor').setWysiwygEditorValue("");
				}
   ...
   $('form.Activity :submit').live('click', function() {
	  ...
	  if( $.sceditor || $(inp).data('sceditor') ) {
		$(inp).data('sceditor').updateTextareaValue();
	  }
