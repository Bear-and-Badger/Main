function Gdn_Quotes() {
   ...
   Gdn_Quotes.prototype.Prepare = function() {
	  ...
	  $('div.sceditor-container').livequery(function(){
		 Quotes.SetInsertMode('sceditor', this);
	  });
   }
...
*/
   ...
   Gdn_Quotes.prototype.Quote = function(ObjectID, QuoteLink) {
      ...
      switch (this.InsertMode) {
         ...
         break;
		 case 'sceditor':
			var ScrollY = this.GetEditor().parent().offset().top - 100;
		 break;
         case 'default':
         default:
   ...
   Gdn_Quotes.prototype.ApplyQuoteText = function(QuoteText) {
      ...
      switch (this.InsertMode) {
         ...
         break;
         case 'sceditor':
			var sceditor = Editor.data('sceditor');
			sceditor.setWysiwygEditorValue( sceditor.getWysiwygEditorValue() + QuoteText );
			sceditor.updateTextareaValue();
		 break;
         case 'default':
         default:
            // Do nothing special
