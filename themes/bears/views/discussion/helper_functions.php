...
<li class="<?php echo $CssClass; ?>" id="<?php echo $Id; ?>">
   <div class="Comment clearfix">
	<div class="TopBar clearfix">
		...
		<div class="MessageOptions" style="text-align:right;">
      ...
      <div class="Meta">
         ...
         <div class="CommentInfo">
            ...
            ?>
			<?php if( $Object->InsertUserID != $Session->UserID ) : ?>
			<br />
			<a class="Popup" href="/messages/add/<?php echo $Author->Name; ?>">Send message</a>
			<?php endif; ?>
         </div>
