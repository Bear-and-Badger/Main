...
<li class="<?php echo $CssClass; ?>">
   ...
   <div class="ItemContent Discussion">
      ...
      <div class="Meta">
         ...
         <span class="Announcement"><?php echo T('Sticky'); ?></span>
         <?php } ?>
         <?php if ($Discussion->Closed == '1') { ?>
         <span class="Closed"><?php echo T('Closed'); ?></span>
         <?php } ?>
		 
		 <span class="FirstPageLink"> <a class="pagenavigator" href="/vanilla/index.php?p=/discussion/<?php echo $Discussion->DiscussionID; ?>/x/p1">First page</a></span>
		...
		<?php
            if ($Session->IsValid() && $Discussion->CountUnreadComments > 0)
               echo '<strong class="NumberNewComments">'.Plural($Discussion->CountUnreadComments, '%s New', '%s New Plural').'</strong>';
